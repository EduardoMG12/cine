...
func (p *PasswordHasher) ComparePasswordAndHash(password, encodedHash string) error {
...
func decodeHash(encodedHash string) (p *PasswordHasher, salt, hash []byte, err error) {
